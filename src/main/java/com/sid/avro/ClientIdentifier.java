...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6141580400046365851L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"com.sid.avro\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   */
  public static com.sid.avro.ClientIdentifier.Builder newBuilder() {
    return new com.sid.avro.ClientIdentifier.Builder();
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static com.sid.avro.ClientIdentifier.Builder newBuilder(com.sid.avro.ClientIdentifier.Builder other) {
    if (other == null) {
      return new com.sid.avro.ClientIdentifier.Builder();
    } else {
      return new com.sid.avro.ClientIdentifier.Builder(other);
    }
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static com.sid.avro.ClientIdentifier.Builder newBuilder(com.sid.avro.ClientIdentifier other) {
    if (other == null) {
      return new com.sid.avro.ClientIdentifier.Builder();
    } else {
      return new com.sid.avro.ClientIdentifier.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sid.avro.ClientIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sid.avro.ClientIdentifier other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostName)) {
        this.hostName = data().deepCopy(fields()[0].schema(), other.hostName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.ClientIdentifier.Builder setHostName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.ClientIdentifier.Builder clearHostName() {
      hostName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.ClientIdentifier.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.ClientIdentifier.Builder clearIpAddress() {
      ipAddress = null;
