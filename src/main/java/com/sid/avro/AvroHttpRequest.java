...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AvroHttpRequest fromByteBuffer(
   ...
   private com.sid.avro.ClientIdentifier clientIdentifier;
   private java.util.List<java.lang.CharSequence> employeeNames;
   private com.sid.avro.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, com.sid.avro.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, com.sid.avro.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (com.sid.avro.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (com.sid.avro.Active)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.sid.avro.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.sid.avro.ClientIdentifier value) {
   ...
   */
  public com.sid.avro.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.sid.avro.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.sid.avro.AvroHttpRequest.Builder newBuilder() {
    return new com.sid.avro.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.sid.avro.AvroHttpRequest.Builder newBuilder(com.sid.avro.AvroHttpRequest.Builder other) {
    if (other == null) {
      return new com.sid.avro.AvroHttpRequest.Builder();
    } else {
      return new com.sid.avro.AvroHttpRequest.Builder(other);
    }
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.sid.avro.AvroHttpRequest.Builder newBuilder(com.sid.avro.AvroHttpRequest other) {
    if (other == null) {
      return new com.sid.avro.AvroHttpRequest.Builder();
    } else {
      return new com.sid.avro.AvroHttpRequest.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private long requestTime;
    private com.sid.avro.ClientIdentifier clientIdentifier;
    private com.sid.avro.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private com.sid.avro.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sid.avro.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.sid.avro.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sid.avro.AvroHttpRequest other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder setClientIdentifier(com.sid.avro.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.sid.avro.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.sid.avro.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.sid.avro.ClientIdentifier.newBuilder());
        }
      }
    ...
    public com.sid.avro.AvroHttpRequest.Builder setClientIdentifierBuilder(com.sid.avro.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder setActive(com.sid.avro.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sid.avro.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.sid.avro.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.sid.avro.Active) defaultValue(fields()[3]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.clientIdentifier == null) {
        this.clientIdentifier = new com.sid.avro.ClientIdentifier();
      }
      ...
      this.active = com.sid.avro.Active.values()[in.readEnum()];
